...
execute if entity @s[scores={activate_second=0}] run replaceitem entity @s hotbar.1 carrot_on_a_stick{display:{Name:"{\"translate\":\"stun\",\"color\":\"white\"}",Lore:["{\"translate\":\"stun_lore1\",\"color\":\"white\"}","{\"translate\":\"stun_lore2\",\"color\":\"white\"}"]},HideFlags:63,CustomModelData:11140001,Unbreakable:1}
...
execute if entity @s[scores={activate_second=1}] run function classes:shocksmith/stun/activate
scoreboard players add @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=5}] run function classes:shocksmith/stun/deactivate
scoreboard players set @s[scores={activate_second=50..}] activate_second 0
...
execute if entity @s[scores={activate_third=1}] run function classes:shocksmith/energy_sap/activate
scoreboard players add @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=200}] run function classes:shocksmith/energy_sap/deactivate
...
replaceitem entity @s[scores={reload=0,shoot=0}] hotbar.0 carrot_on_a_stick{display:{Name:"{\"translate\":\"shock_hopper\"}",Lore:["{\"translate\":\"shock_hopper_lore\",\"color\":\"white\"}","{\"text\":\" - damage: 15\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - ammo: 6\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - reload speed: 2.5s\",\"color\":\"white\",\"italic\":false}"]},HideFlags:63,CustomModelData:11140000,Unbreakable:1}
replaceitem entity @s[scores={reload=0,shoot=1..}] hotbar.0 paper{display:{Name:"{\"translate\":\"shock_hopper\"}",Lore:["{\"translate\":\"shock_hopper_lore\",\"color\":\"white\"}","{\"text\":\" - damage: 15\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - ammo: 6\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - reload speed: 2.5s\",\"color\":\"white\",\"italic\":false}"]},HideFlags:63,CustomModelData:11140000}
...
scoreboard players set @s[scores={shoot=8..}] shoot 0
