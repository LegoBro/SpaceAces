replaceitem entity @s[tag=!invis,scores={crouching=0}] armor.head minecraft:leather_helmet{HideFlags:63,AttributeModifiers:[{AttributeName:"generic.movementSpeed",Name:"generic.movementSpeed",Amount:0.5,Operation:2,UUIDLeast:513394,UUIDMost:210043}],Unbreakable:1,display:{color:6541567},Enchantments:[{id:"minecraft:binding_curse",lvl:1}]}
...
execute if entity @s[scores={activate_second=0}] run replaceitem entity @s hotbar.1 carrot_on_a_stick{display:{Name:"{\"translate\":\"boost\",\"color\":\"white\"}",Lore:["{\"translate\":\"boost_lore1\",\"color\":\"white\"}","{\"translate\":\"boost_lore2\",\"color\":\"white\"}"]},HideFlags:63,CustomModelData:11010001,Unbreakable:1}
...
execute if entity @s[scores={activate_second=1}] run function classes:scout/boost/activate
scoreboard players add @s[scores={activate_second=1..}] activate_second 1
execute if entity @s[scores={activate_second=20}] run function classes:scout/boost/deactivate
scoreboard players set @s[scores={activate_second=60..}] activate_second 0
execute if entity @s[scores={activate_third=0}] run replaceitem entity @s hotbar.2 carrot_on_a_stick{display:{Name:"{\"translate\":\"launch\",\"color\":\"white\"}",Lore:["{\"translate\":\"launch_lore1\",\"color\":\"white\"}","{\"translate\":\"launch_lore2\",\"color\":\"white\"}"]},HideFlags:63,CustomModelData:11010002,Unbreakable:1}
...
execute if entity @s[scores={activate_third=1}] run function classes:scout/launch/activate
scoreboard players add @s[scores={activate_third=1..}] activate_third 1
execute if entity @s[scores={activate_third=5}] run function classes:scout/launch/deactivate
...
replaceitem entity @s[scores={reload=0,shoot=0}] hotbar.0 carrot_on_a_stick{display:{Name:"{\"translate\":\"surge_pistol\"}",Lore:["{\"translate\":\"surge_pistol_lore\",\"color\":\"white\"}","{\"text\":\" - damage: 12\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - ammo: 8\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - reload speed: 1s\",\"color\":\"white\",\"italic\":false}"]},HideFlags:63,CustomModelData:11010000,Unbreakable:1}
replaceitem entity @s[scores={reload=0,shoot=1..}] hotbar.0 paper{display:{Name:"{\"translate\":\"surge_pistol\"}",Lore:["{\"translate\":\"surge_pistol_lore\",\"color\":\"white\"}","{\"text\":\" - damage: 12\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - ammo: 8\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - reload speed: 1s\",\"color\":\"white\",\"italic\":false}"]},HideFlags:63,CustomModelData:11010000}
