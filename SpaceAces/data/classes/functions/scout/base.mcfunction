...
replaceitem entity @s[scores={reload=0,shoot=0}] hotbar.0 carrot_on_a_stick{display:{Name:"{\"translate\":\"surge_pistol\"}",Lore:["{\"translate\":\"surge_pistol_lore\",\"color\":\"white\"}","{\"text\":\" - damage: 15\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - ammo: 8\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - reload speed: 1s\",\"color\":\"white\",\"italic\":false}"]},HideFlags:63,CustomModelData:11010000,Unbreakable:1}
replaceitem entity @s[scores={reload=0,shoot=1..}] hotbar.0 paper{display:{Name:"{\"translate\":\"surge_pistol\"}",Lore:["{\"translate\":\"surge_pistol_lore\",\"color\":\"white\"}","{\"text\":\" - damage: 15\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - ammo: 8\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - reload speed: 1s\",\"color\":\"white\",\"italic\":false}"]},HideFlags:63,CustomModelData:11010000}
