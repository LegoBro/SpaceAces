...
replaceitem entity @s[scores={reload=0,shoot=0}] hotbar.0 carrot_on_a_stick{display:{Name:"{\"translate\":\"plasma_cannon\"}",Lore:["{\"translate\":\"plasma_cannon_lore\",\"color\":\"white\"}","{\"text\":\" - damage: 5\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - ammo: 30\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - reload speed: 3.5s\",\"color\":\"white\",\"italic\":false}"]},HideFlags:63,CustomModelData:11050000,Unbreakable:1}
replaceitem entity @s[scores={reload=0,shoot=1..}] hotbar.0 paper{display:{Name:"{\"translate\":\"plasma_cannon\"}",Lore:["{\"translate\":\"plasma_cannon_lore\",\"color\":\"white\"}","{\"text\":\" - damage: 5\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - ammo: 30\",\"color\":\"white\",\"italic\":false}","{\"text\":\" - reload speed: 3.5s\",\"color\":\"white\",\"italic\":false}"]},HideFlags:63,CustomModelData:11050000}
