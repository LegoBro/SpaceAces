...
execute if entity @s[tag=blue] at @e[limit=1,sort=nearest,tag=!raycast] run scoreboard players operation @e[distance=0,limit=1,sort=nearest,team=!blue,tag=!raycast] 2xdamage += @s damage
...
execute if entity @s[tag=red] at @e[limit=1,sort=nearest,tag=!raycast] run scoreboard players operation @e[distance=0,limit=1,sort=nearest,team=!red,tag=!raycast] 2xdamage += @s damage
