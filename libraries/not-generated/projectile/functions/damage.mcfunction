...
execute if entity @s[tag=blue] at @e[type=!item_frame,tag=!turret,limit=1,sort=nearest,tag=!raycast] run scoreboard players operation @e[type=!item_frame,tag=!turret,distance=0,limit=1,sort=nearest,team=!blue,tag=!raycast] damage += @s damage
...
execute if entity @s[tag=red] at @e[type=!item_frame,tag=!turret,limit=1,sort=nearest,tag=!raycast] run scoreboard players operation @e[type=!item_frame,tag=!turret,distance=0,limit=1,sort=nearest,team=!red,tag=!raycast] damage += @s damage
